    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('producer', 'Producer'), ('admin', 'Administrator')], default='customer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='customer_profile', serialize=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('organization_type', models.CharField(blank=True, choices=[('school', 'School'), ('charity', 'Charity'), ('community', 'Community Group'), ('other', 'Other')], max_length=50)),
